...
public class Autocomplete {
     ...
     * @throws IllegalArgumentException if the terms and weights are
     ...
     * @return Weight of the given term as a double, if it is in the dictionary. Otherwise, 0.0.
     */
    ...
    public String topMatch(String prefix) {
        for (String match : topMatches(prefix, 1)) {
            return match;
        }
        return null;
    }
     ...
     * @return Top k matching terms as a String (in descending order of weight) as an iterable.
     */
    public Iterable<String> topMatches(String prefix, int k) {
        return t.topMatches(prefix, k);
    }
